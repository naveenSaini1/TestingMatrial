package com.example.jdbcsecurity.repositaryimpl;
...
import com.example.jdbcsecurity.utitly.MessageMapper;
...
public class UserRepoImpl implements UserRepo{
	...
	public Map<String, ResponseMessage<Integer>> insertTheUser(User user) {
		...
		try {
			String sql="insert into jdbc.user(u_id , name , bio ,age ,password,email,role ) values(?,?,?,?,?,?,?)";
